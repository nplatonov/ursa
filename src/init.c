...
static R_NativePrimitiveArgType scatterplot_t[] = {
...
static R_NativePrimitiveArgType dist2dist_t[] = {
   REALSXP, REALSXP, REALSXP, REALSXP, INTSXP, INTSXP, INTSXP, INTSXP, INTSXP, REALSXP, INTSXP
};
...
static const R_CMethodDef CEntries[] = {
   ...
   {"scatterplot", (DL_FUNC) &scatterplot, 8, scatterplot_t},
   ...
   {"dist2dist", (DL_FUNC) &dist2dist, 11, dist2dist_t},
